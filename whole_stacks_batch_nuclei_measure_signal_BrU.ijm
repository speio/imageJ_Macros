...
input = '/Users/speio/OneDrive/Uconn-Sem-9/FP_TimeCourse_Int_LamB_staining/PolII_f12_Int11_FP-DMSO/deconvoluted_images_only/Images_to_process/';
output = '/Users/speio/OneDrive/Uconn-Sem-9/FP_TimeCourse_Int_LamB_staining/PolII_f12_Int11_FP-DMSO/deconvoluted_images_only/Area_measure_result_tables/'
outputImages = '/Users/speio/OneDrive/Uconn-Sem-9/FP_TimeCourse_Int_LamB_staining/PolII_f12_Int11_FP-DMSO/deconvoluted_images_only/Area_measure_output_images/'
...
function area_measure() {	
	...
	close();
	// Create binary mask
	selectWindow("AVG_C3-"+imageTitle); 
	...
	// Save results for both channel measurements
		...
		saveAs('txt', output + "C2_and_C1" + imageTitle);
		saveAs('txt', output + "C2_and_C1" + "All_results");
		close();
		selectWindow("Results");
		close();
